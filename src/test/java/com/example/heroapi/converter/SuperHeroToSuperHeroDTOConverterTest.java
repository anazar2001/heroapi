...
/**
 * Unit tests for {@link SuperHeroToSuperHeroDTOConverter}.
 */
class SuperHeroToSuperHeroDTOConverterTest {

    private static Converter<SuperHero, SuperHeroDTO> converter;

    @BeforeAll
    public static void setUp() {
        converter = new SuperHeroToSuperHeroDTOConverter();
    }
    ...
    void testConvert() {
        ...
        // when
        SuperHeroDTO superHeroDto = converter.convert(superHero);
